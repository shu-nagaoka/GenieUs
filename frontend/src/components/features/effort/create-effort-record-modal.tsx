...
import { Save, Loader2, Plus, X, Trophy, Heart, Star } from 'lucide-react'
                ...
                <div key={key} className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-bold text-gray-800">
                      {formData.categories[key as keyof typeof formData.categories]}%
                    </span>
                  </div>
                  <Input
                    type="range"
                  ...
                  <div className="h-2 rounded-full bg-gray-200">
                    <div
                      ...
                      style={{
                        width: `${formData.categories[key as keyof typeof formData.categories]}%`,
                      }}
                    ></div>
                  </div>
                </div>
